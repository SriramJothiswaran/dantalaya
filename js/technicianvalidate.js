var firstname = document.forms["contactForm"]["contactName"];
      ...
      col.addEventListener("blur", colVerify, true);
        ...
        if(startDateValue == null || startDateValue == ""){
          ...
          document.getElementById("si_error").innerHTML = "DOB is required";
          errorArray.push(si);
          si.focus();
          ok = false;
          }
        ...
        if(endDateValue == null || endDateValue == ""){
          ...
          document.getElementById("ci_error").innerHTML = "DOB is required";
          errorArray.push(ci);
          ci.focus();
          ok = false;
          }
        ...
        if(colValue == null || colValue == ""){
          ...
          document.getElementById("col_error").style.color = "red";
          document.getElementById("col_error").innerHTML = "Enter college/institution name";
          errorArray.push(col);
          col.focus();
          ok = false;
        }
          ...
          document.getElementById("col_error").innerHTML="";
        }
